...
from account.views import RegistrationView, ActivateView, ActivationConfirm, GetCSRFToken, LoginView, LogoutView, UserDetailView, ChangePasswordView, DeleteAccountView, ResetPasswordEmailView, ResetPasswordView,ResetPasswordConfirmView, CheckAuthenticatedView
